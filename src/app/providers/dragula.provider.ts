...
export class DragulaService {
    ...
    private domIndexOf(child: any, parent: any) {
        let filteredChildren = Array.from(parent.children).filter((ch: HTMLElement) => {
            return !ch.classList.contains("dragula-ignored");
        });
        return Array.prototype.indexOf.call(filteredChildren, child);
    }
}
